...
import "./_group.css";
export function GroupLeaderMobile(){return <div className="pulse-ai"><main className="main"><div className="mobile-actions" style={{justifyContent:"space-between",marginBottom:24}}><Brand/><div className="mobile-actions"><Bell size={18}/><span className="avatar">AN</span></div></div><Header group/><KPI group/><section style={{marginTop:24}}><AskPulse/></section><Groups group/><Attention group/><Lower group/><BottomNav/></main></div>}
